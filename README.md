...
Please submit your **ideas**, **bugs reports** or **requests** regarding:
...
See our [development guide](/DEVELOPMENT.md) on how to run the site on local machine for development.
...
To execute the test suite run `rspec spec`. You need to install [dependencies](/setup.sh) first and the site has to be allready generated and available in `_site/` folder.

## Contributing

Contributions are welcome! For more information see our [Contributing Guide](https://developer-portal.github.io/contributing).

You can find us on `freenode` under `#developer-portal` if you have any further questions or suggestions.
